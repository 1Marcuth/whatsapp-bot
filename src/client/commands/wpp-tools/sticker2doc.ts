...
export const command: ICommand = {
    name: "sticker2doc",
    description: "Transforma figurinha em uma imagem e envia como documento no chat.",
    run: async (context) => {
        ...
        await context.replyText("Aguarde! Estou convertendo sua figurinha para uma imagem e assim que terminar, enviarei como documento aqui no chat, ok?")

        const imageFileName = randString(10) + ".png"
        ...
        await context.sendDocument(imageFilePath, true, "image/png")
